...
[Flask Server]
     ↓
[Web Game / Visualization]
```

- 센서 입력은 **Serial → WebSocket** 구조로 전달
- 실시간 제어 실패 시 **CSV / 키보드 입력 기반 대체 시연 가능**

---

## 📅 단계별 일정 분할
> 모든 일정은 **통합 동작 여부**를 기준으로 평가한다.

| 단계 | 기간 | 목표 | 완성 기준 (Feature) | 비고 |
|---|---|---|---|---|
| 준비 | ~ 2026-03-02 | 개발 준비 | API 계약<br>더미 데이터<br>개발 환경 구축 ||
